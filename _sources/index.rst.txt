...
The `MolSSI Driver Interface (MDI)<https://github.com/MolSSI-MDI/MDI_Library>`_ project provides a :ref:`standardized API<mdi_standard>` for fast, on-the-fly communication between computational chemistry codes.
