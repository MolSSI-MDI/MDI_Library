...
/*! \brief Send a message through an MDI connection, using TCP
 *
 * \param [in]       buf
 *                   Pointer to the data to be sent.
 * \param [in]       count
 ...
 *                   MDI communicator associated with the intended recipient code.
 */
int tcp_send_msg(const void* buf, int count, MDI_Datatype datatype, MDI_Comm comm) {
  int ret = 0;
...
/*! \brief Receive a message through an MDI connection, using TCP
 *
 * \param [in]       buf
 *                   Pointer to the buffer where the received data will be stored.
 * \param [in]       count
 ...
 *                   MDI communicator associated with the connection to the sending code.
 */
int tcp_recv_msg(void* buf, int count, MDI_Datatype datatype, MDI_Comm comm) {
  int ret = 0;
