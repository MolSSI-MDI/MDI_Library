...
DllExport MDI_Driver_node_callback_t MDI_Get_language_driver_callback();
DllExport int MDI_Set_language_driver_callback(MDI_Driver_node_callback_t callback);
