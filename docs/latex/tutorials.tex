...
There are two scripts associated with the water test\+: {\ttfamily tcp.\+sh} and \textbackslash{}mpi.sh. The {\ttfamily tcp.\+sh} script will run the simulation using the T\+C\+P/\+IP method for communicating between the driver and the engines. It consists of the following code\+:
