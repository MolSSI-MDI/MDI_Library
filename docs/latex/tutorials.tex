...
\DoxyCodeLine{\mbox{\hyperlink{mdi_8c_ab73f32323a155011fcc184866215ba03}{MDI\_Recv}}(code\_name, MDI\_NAME\_LENGTH, MDI\_CHAR, comm);}
\end{DoxyCode}
...
\DoxyCodeLine{  \mbox{\hyperlink{mdi_8c_a77e579331a36c3f0eb7f7ff9668e789d}{MDI\_Send\_Command}}(\textcolor{stringliteral}{"<NAME"}, comm);}
\DoxyCodeLine{  \mbox{\hyperlink{mdi_8c_ab73f32323a155011fcc184866215ba03}{MDI\_Recv}}(engine\_name, MDI\_NAME\_LENGTH, MDI\_CHAR, comm);}
\DoxyCodeLine{}
...
\DoxyCodeLine{\mbox{\hyperlink{mdi_8c_ab73f32323a155011fcc184866215ba03}{MDI\_Recv}}(\&natoms, 1, MDI\_INT, mm\_comm);}
\end{DoxyCode}
...
\DoxyCodeLine{\mbox{\hyperlink{mdi_8c_ab73f32323a155011fcc184866215ba03}{MDI\_Recv}}(\&coords, 3*natoms, MDI\_DOUBLE, mm\_comm);}
\end{DoxyCode}
...
\DoxyCodeLine{\mbox{\hyperlink{mdi_8c_a7bebce6d5fa91ee99a34fdcc5dcaedea}{MDI\_Send}}(\&coords, 3*natoms, MDI\_DOUBLE, qm\_comm);}
\end{DoxyCode}


\begin{DoxyNote}{Note}
As we will discuss later in \mbox{\hyperlink{index_running_sec}{Running With M\+DI}}, this driver assumes that the engines have both been initialized with the same number of atoms, the same atom types and ordering of atom types, and the same cell dimensions.
\end{DoxyNote}
...
\DoxyCodeLine{  \mbox{\hyperlink{mdi_8c_ab73f32323a155011fcc184866215ba03}{MDI\_Recv}}(\&qm\_energy, 1, MDI\_DOUBLE, qm\_comm);}
\DoxyCodeLine{}
...
\DoxyCodeLine{  \mbox{\hyperlink{mdi_8c_ab73f32323a155011fcc184866215ba03}{MDI\_Recv}}(\&mm\_energy, 1, MDI\_DOUBLE, mm\_comm);}
\DoxyCodeLine{}
...
\DoxyCodeLine{  \mbox{\hyperlink{mdi_8c_ab73f32323a155011fcc184866215ba03}{MDI\_Recv}}(\&forces, 3*natoms, MDI\_DOUBLE, qm\_comm);}
\DoxyCodeLine{}
...
\DoxyCodeLine{  \mbox{\hyperlink{mdi_8c_a7bebce6d5fa91ee99a34fdcc5dcaedea}{MDI\_Send}}(\&forces, 3*natoms, MDI\_DOUBLE, mm\_comm);}
\DoxyCodeLine{}
...
\DoxyCodeLine{make}
\end{DoxyCode}
\hypertarget{index_running_sec}{}\doxysubsection{Running With M\+DI}\label{index_running_sec}
