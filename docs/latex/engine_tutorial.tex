...
\item Call {\ttfamily \mbox{\hyperlink{mdi_8c_ae05ae377fa8de592f62c696c041b7d0a}{M\+D\+I\+\_\+\+Init()}}} and {\ttfamily \mbox{\hyperlink{mdi_8c_a27002da8665201b9d0e9bdb4f51f64d8}{M\+D\+I\+\_\+\+Accept\+\_\+\+Communicator()}}} as early as possible in your engine.
...
Your code must initialize the M\+DI Library by calling the {\ttfamily \mbox{\hyperlink{mdi_8c_ae05ae377fa8de592f62c696c041b7d0a}{M\+D\+I\+\_\+\+Init()}}} function. This is a straightforward process, but there are a couple of important details to keep in mind if you are using both M\+DI and the Message Passing Interface (M\+PI)\+:
\begin{DoxyItemize}
\item If your code uses M\+PI, you should call {\ttfamily \mbox{\hyperlink{mdi_8c_ae05ae377fa8de592f62c696c041b7d0a}{M\+D\+I\+\_\+\+Init()}}} after the call to {\ttfamily M\+P\+I\+\_\+\+Init()} (or {\ttfamily M\+P\+I\+\_\+\+Init\+\_\+thread()}, if applicable). Aside from the restriction, {\ttfamily \mbox{\hyperlink{mdi_8c_ae05ae377fa8de592f62c696c041b7d0a}{M\+D\+I\+\_\+\+Init()}}} should be called as early in your code as possible. It is a best practice to call {\ttfamily \mbox{\hyperlink{mdi_8c_ae05ae377fa8de592f62c696c041b7d0a}{M\+D\+I\+\_\+\+Init()}}} immediately after calling {\ttfamily M\+P\+I\+\_\+\+Init()}. Calling M\+PI functions (other than {\ttfamily M\+P\+I\+\_\+\+Init()} or {\ttfamily M\+P\+I\+\_\+\+Init\+\_\+thread()}) before calling {\ttfamily \mbox{\hyperlink{mdi_8c_ae05ae377fa8de592f62c696c041b7d0a}{M\+D\+I\+\_\+\+Init()}}} will lead to bugs.
\item One of the required arguments to the {\ttfamily \mbox{\hyperlink{mdi_8c_ae05ae377fa8de592f62c696c041b7d0a}{M\+D\+I\+\_\+\+Init()}}} function is an M\+PI intra-\/communicator. Upon calling {\ttfamily \mbox{\hyperlink{mdi_8c_ae05ae377fa8de592f62c696c041b7d0a}{M\+D\+I\+\_\+\+Init()}}}, this intra-\/communicator must correspond to the intra-\/communicator that includes all global ranks ({\itshape e.\+g.}, {\ttfamily M\+P\+I\+\_\+\+C\+O\+M\+M\+\_\+\+W\+O\+R\+LD}). The {\ttfamily \mbox{\hyperlink{mdi_8c_ae05ae377fa8de592f62c696c041b7d0a}{M\+D\+I\+\_\+\+Init()}}} function will then perform an {\ttfamily M\+P\+I\+\_\+\+Comm\+\_\+split()} operation to obtain an inter-\/communicator that includes only ranks associated with your engine. As an engine developer, you should {\bfseries{never}} perform M\+PI operations involving {\ttfamily M\+P\+I\+\_\+\+C\+O\+M\+M\+\_\+\+W\+O\+R\+LD}. Instead, use the intra-\/communicator that is provided by the M\+DI Library whenever you would have otherwise used {\ttfamily M\+P\+I\+\_\+\+C\+O\+M\+M\+\_\+\+W\+O\+R\+LD}. You should replace any existing references to {\ttfamily M\+P\+I\+\_\+\+C\+O\+M\+M\+\_\+\+W\+O\+R\+LD} in your code with a reference to the intra-\/communicator obtained from calling {\ttfamily \mbox{\hyperlink{mdi_8c_ae05ae377fa8de592f62c696c041b7d0a}{M\+D\+I\+\_\+\+Init()}}}.
\end{DoxyItemize}
...
\DoxyCodeLine{MPI\_Comm *world\_comm\_ptr = \&world\_comm;}
\DoxyCodeLine{}
...
\DoxyCodeLine{initialize(\textcolor{keywordtype}{char} *mdi\_options, MPI\_Comm *world\_comm\_ptr) \{}
\DoxyCodeLine{}
\DoxyCodeLine{  \textcolor{comment}{/* If using MPI, it should be initialized before MDI */}}
\DoxyCodeLine{  MPI\_Init();}
\DoxyCodeLine{}
\DoxyCodeLine{  \textcolor{comment}{/* Set the value of world\_comm}}
\DoxyCodeLine{\textcolor{comment}{     Note: if you are not using MPI, set world\_comm to MDI\_COMM\_NULL instead */}}
\DoxyCodeLine{  *world\_comm\_ptr = MPI\_COMM\_WORLD;}
\DoxyCodeLine{}
\DoxyCodeLine{  \textcolor{comment}{/* MDI should be initialized immediately after MPI */}}
\DoxyCodeLine{  \mbox{\hyperlink{mdi_8c_ae05ae377fa8de592f62c696c041b7d0a}{MDI\_Init}}(mdi\_options, world\_comm\_ptr);}
...
\DoxyCodeLine{  MPI\_Comm\_rank(world\_comm, my\_rank);}
\DoxyCodeLine{}
\DoxyCodeLine{  \textcolor{comment}{/* Accept a connection from an external driver */}}
\DoxyCodeLine{  \textcolor{keywordflow}{if} ( my\_rank == 0 ) \{}
\DoxyCodeLine{    \mbox{\hyperlink{mdi_8c_a27002da8665201b9d0e9bdb4f51f64d8}{MDI\_Accept\_Communicator}}(\&mdi\_comm);}
\DoxyCodeLine{  \}}
\DoxyCodeLine{\}}
\end{DoxyCode}


After implementing the call to {\ttfamily \mbox{\hyperlink{mdi_8c_ae05ae377fa8de592f62c696c041b7d0a}{M\+D\+I\+\_\+\+Init()}}}, you should recompile the code to confirm that your executable is linked to the M\+PI Library.
...
\DoxyCodeLine{        \textcolor{keyword}{CALL }mdi\_init(mdi\_options, world\_comm, ierr)}
...
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{\# MPI intra-\/communicator for all processes running this code}}
\DoxyCodeLine{\textcolor{comment}{\# It should be set to MPI.COMM\_WORLD prior to the call to MDI\_Init(), as shown below}}
\DoxyCodeLine{\textcolor{comment}{\# Afterwards, you should ALWAYS use this variable instead of MPI.COMM\_WORLD}}
\DoxyCodeLine{\textcolor{keywordflow}{if} use\_mpi4py:}
\DoxyCodeLine{    world\_comm = MPI.COMM\_WORLD}
\DoxyCodeLine{\textcolor{keywordflow}{else}:}
\DoxyCodeLine{    world\_comm = \textcolor{keywordtype}{None}}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{\# Get the command-\/line options for MDI}}
\DoxyCodeLine{...}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{\# Initialize MDI}}
\DoxyCodeLine{mdi.MDI\_Init(mdi\_options, world\_comm)}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{\# Set world\_comm to the correct intra-\/code MPI communicator}}
\DoxyCodeLine{world\_comm = MDI\_Get\_Intra\_Code\_MPI\_Comm()}
\DoxyCodeLine{\textcolor{comment}{\# Following this point, world\_comm should be used whenever you would otherwise have used MPI.COMM\_WORLD}}
\DoxyCodeLine{}
...
\DoxyCodeLine{\textcolor{comment}{\# Accept a connection from an external driver}}
\DoxyCodeLine{\textcolor{keywordflow}{if} my\_rank == 0:}
\DoxyCodeLine{    mdi\_comm = \mbox{\hyperlink{mdi_8c_a27002da8665201b9d0e9bdb4f51f64d8}{MDI\_Accept\_Communicator}}()}
\end{DoxyCode}
...
\DoxyCodeLine{    \textcolor{keywordflow}{if} ( my\_rank == 0 ) \{}
\DoxyCodeLine{      \mbox{\hyperlink{mdi_8c_ab03c0ea8beda690d6f796d3089cbfe15}{MDI\_Recv\_Command}}(command, mdi\_comm);}
\DoxyCodeLine{    \}}
...
\DoxyCodeLine{    \mbox{\hyperlink{mdi_8c_a013856347b9026a7eb01e7803b3dc9b5}{MDI\_Check\_Command\_Exists}}(node\_name, command, \mbox{\hyperlink{mdi_8c_a01e277b0239a7304055c883adb759280}{MDI\_COMM\_NULL}}, \&command\_supported);}
...
M\+DI requires you to \char`\"{}register\char`\"{} a list of all nodes and commands your engine supports. This allows you, as an engine developer, to inform any drivers of what your code can do. M\+DI provides two functions that allow you to do this\+: {\ttfamily \mbox{\hyperlink{mdi_8c_ada45c73f15462764df0ac9e733b7d18e}{M\+D\+I\+\_\+\+Register\+\_\+\+Node()}}} and {\ttfamily \mbox{\hyperlink{mdi_8c_a8eade50fb64b5bf5919b35cc2071952d}{M\+D\+I\+\_\+\+Register\+\_\+\+Command()}}}. The engine we have developed thus far in the tutorial only supports a single node, and that node only supports a single command. As a result, we need to call {\ttfamily \mbox{\hyperlink{mdi_8c_ada45c73f15462764df0ac9e733b7d18e}{M\+D\+I\+\_\+\+Register\+\_\+\+Node()}}} once to register the {\ttfamily @D\+E\+F\+A\+U\+LT} node and call {\ttfamily \mbox{\hyperlink{mdi_8c_a8eade50fb64b5bf5919b35cc2071952d}{M\+D\+I\+\_\+\+Register\+\_\+\+Command()}}} once to register the {\ttfamily E\+X\+IT} command.

Fortunately, this is a very simple process. The only argument to the {\ttfamily \mbox{\hyperlink{mdi_8c_ada45c73f15462764df0ac9e733b7d18e}{M\+D\+I\+\_\+\+Register\+\_\+\+Node()}}} function is the name of the node, {\ttfamily @D\+E\+F\+A\+U\+LT}. The {\ttfamily \mbox{\hyperlink{mdi_8c_a8eade50fb64b5bf5919b35cc2071952d}{M\+D\+I\+\_\+\+Register\+\_\+\+Command()}}} function accepts two arguments\+: the name of the node, and the name of the command that we are registering at that node, {\ttfamily E\+X\+IT}. In time, you may add support for additional commands at the default node, making additional calls to {\ttfamily \mbox{\hyperlink{mdi_8c_a8eade50fb64b5bf5919b35cc2071952d}{M\+D\+I\+\_\+\+Register\+\_\+\+Command()}}} for each newly supported command. If you add additional nodes, each node will have its own list of registered commands, which may be different from the list of commands supported at the {\ttfamily @D\+E\+F\+A\+U\+LT} node.

For now, place the following code immediately after your engine\textquotesingle{}s call to {\ttfamily \mbox{\hyperlink{mdi_8c_ae05ae377fa8de592f62c696c041b7d0a}{M\+D\+I\+\_\+\+Init()}}}. It is important that it be called prior to the call to {\ttfamily \mbox{\hyperlink{mdi_8c_a27002da8665201b9d0e9bdb4f51f64d8}{M\+D\+I\+\_\+\+Accept\+\_\+\+Communicator()}}}.
...
\DoxyCodeLine{\mbox{\hyperlink{mdi_8c_ada45c73f15462764df0ac9e733b7d18e}{MDI\_Register\_Node}}(\textcolor{stringliteral}{"@DEFAULT"});}
\DoxyCodeLine{\mbox{\hyperlink{mdi_8c_a8eade50fb64b5bf5919b35cc2071952d}{MDI\_Register\_Command}}(\textcolor{stringliteral}{"@DEFAULT"}, \textcolor{stringliteral}{"EXIT"});}
\end{DoxyCode}
...
\item Add a call to {\ttfamily \mbox{\hyperlink{mdi_8c_a8eade50fb64b5bf5919b35cc2071952d}{M\+D\+I\+\_\+\+Register\+\_\+\+Command()}}} to register support for that command.
\end{DoxyEnumerate}
...
Whenever you add a new node, you must also add a call to {\ttfamily \mbox{\hyperlink{mdi_8c_ada45c73f15462764df0ac9e733b7d18e}{M\+D\+I\+\_\+\+Register\+\_\+\+Node()}}} to register support for that node. Commands are registered separately for each node, so any commands that are supported at the new node must be registered for it. For example, if you implement five nodes, and each of them supports the {\ttfamily E\+X\+IT} command, you will need to call the {\ttfamily \mbox{\hyperlink{mdi_8c_a8eade50fb64b5bf5919b35cc2071952d}{M\+D\+I\+\_\+\+Register\+\_\+\+Command()}}} function five times, each time with a different node as the first argument and with {\ttfamily E\+X\+IT} as the second argument. 