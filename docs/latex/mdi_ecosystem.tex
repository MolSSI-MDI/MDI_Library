...
\item Compile the repository\textquotesingle{}s internal M\+DI distribution by doing\+: \begin{DoxyVerb}cd lammps/lib/mdi
python Install.py -m gcc
\end{DoxyVerb}

\item Activate the {\ttfamily U\+S\+E\+R-\/\+M\+DI} package\+: \begin{DoxyVerb}cd ../../src
make yes-user-mdi
\end{DoxyVerb}
...
\item Launch Tinker using the "{\ttfamily -\/mdi"} runtime option, which is described in \mbox{\hyperlink{library_page_library_launching_sec}{Launching Codes with the M\+DI Library}}. For example\+: \begin{DoxyVerb}time dynamic.x input -mdi "-role ENGINE -name MM -method TCP -port 8021 -hostname localhost" 1000 1.0 10.0 2 298.0 778.0
\end{DoxyVerb}
