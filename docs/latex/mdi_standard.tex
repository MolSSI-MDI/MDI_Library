...
All physical quantities communicated through M\+DI must be expressed in atomic units.\hypertarget{mdi_standard_standard_nodes_sec}{}\doxysubsection{Nodes}\label{mdi_standard_standard_nodes_sec}
...
A typical MD implementation might progress from a @\+P\+RE-\/F\+O\+R\+C\+ES node, to the @\+F\+O\+R\+C\+ES node, to the @\+C\+O\+O\+R\+DS node, and then repeat the cycle; however, this behavior is {\bfseries{not}} guaranteed. Engines are permitted to pass through nodes in whatever order the implementation dictates. When writing drivers, it is a best practice to avoid assumptions about the ordering or frequency of nodes.\hypertarget{mdi_standard_command_list}{}\doxysubsection{Command List}\label{mdi_standard_command_list}
The following is a list of commands that are officially part of the M\+DI standard.\hypertarget{mdi_standard_next_node}{}\doxysubsubsection{@}\label{mdi_standard_next_node}
The engine proceeds to the next node (see \mbox{\hyperlink{mdi_standard_standard_nodes_sec}{Nodes}}). This command requires that either the {\ttfamily M\+D\+\_\+\+I\+N\+IT} command or the {\ttfamily O\+P\+T\+G\+\_\+\+I\+N\+IT} command was previously executed.\hypertarget{mdi_standard_send_node}{}\doxysubsubsection{$<$@}\label{mdi_standard_send_node}
...
\end{DoxyParagraph}
\hypertarget{mdi_standard_set_cell}{}\doxysubsubsection{$>$\+C\+E\+LL}\label{mdi_standard_set_cell}
...
{\bfseries{ Data Type\+: }} M\+D\+I\+\_\+\+D\+O\+U\+B\+LE ~\newline
 ...
 {\bfseries{ Format\+: }} Sequentially ascending order of atomic index
\end{DoxyParagraph}
\hypertarget{mdi_standard_coords_node}{}\doxysubsubsection{@\+C\+O\+O\+R\+DS}\label{mdi_standard_coords_node}
The engine proceeds to the next @\+C\+O\+O\+R\+DS node (see \mbox{\hyperlink{mdi_standard_standard_nodes_sec}{Nodes}}). This command requires that either the {\ttfamily M\+D\+\_\+\+I\+N\+IT} command or the {\ttfamily O\+P\+T\+G\+\_\+\+I\+N\+IT} command was previously executed.\hypertarget{mdi_standard_send_coords}{}\doxysubsubsection{$>$\+C\+O\+O\+R\+DS}\label{mdi_standard_send_coords}
...
The engine terminates and can no longer be sent commands.\hypertarget{mdi_standard_forces_node}{}\doxysubsubsection{@\+F\+O\+R\+C\+ES}\label{mdi_standard_forces_node}
The engine proceeds to the next @\+F\+O\+R\+C\+ES node (see \mbox{\hyperlink{mdi_standard_standard_nodes_sec}{Nodes}}). This command requires that either the {\ttfamily M\+D\+\_\+\+I\+N\+IT} command or the {\ttfamily O\+P\+T\+G\+\_\+\+I\+N\+IT} command was previously executed.\hypertarget{mdi_standard_send_forces}{}\doxysubsubsection{$>$\+F\+O\+R\+C\+ES}\label{mdi_standard_send_forces}
...
{\bfseries{ Note\+: }} This command may change the engine\textquotesingle{}s atomic coordinates under certain circumstances, such as if the S\+H\+A\+KE algorithm is used.
\end{DoxyParagraph}
\hypertarget{mdi_standard_pre-forces_node}{}\doxysubsubsection{@\+P\+R\+E-\/\+F\+O\+R\+C\+ES}\label{mdi_standard_pre-forces_node}
The engine proceeds to the next @\+P\+RE-\/F\+O\+R\+C\+ES node (see \mbox{\hyperlink{mdi_standard_standard_nodes_sec}{Nodes}}). This command requires that either the {\ttfamily M\+D\+\_\+\+I\+N\+IT} command or the {\ttfamily O\+P\+T\+G\+\_\+\+I\+N\+IT} command was previously executed.\hypertarget{mdi_standard_scf_command}{}\doxysubsubsection{S\+CF}\label{mdi_standard_scf_command}
