...
\begin{DoxyParagraph}{}
{\bfseries{ Data Type\+: }} {\ttfamily M\+D\+I\+\_\+\+C\+H\+AR} ~\newline
 {\bfseries{ Quantity\+: }} M\+D\+I\+\_\+\+L\+A\+B\+E\+L\+\_\+\+L\+E\+N\+G\+TH $\ast$ N\+A\+T\+O\+MS ~\newline
 {\bfseries{ Format\+: }} An array of characters corresponding to the label of each atom in ascending order of atomic index, with each label consisting of M\+D\+I\+\_\+\+L\+A\+B\+E\+L\+\_\+\+L\+E\+N\+G\+TH characters and being padded with spaces (\char`\"{} \char`\"{}) where necessary ~\newline
