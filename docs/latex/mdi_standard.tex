...
The engine updates the atomic coordinates for either an MD simulation or a geometry optimization. This command requires that either the {\ttfamily M\+D\+\_\+\+I\+N\+IT} command or the {\ttfamily O\+P\+T\+G\+\_\+\+I\+N\+IT} command was previously executed. The behavior of the {\ttfamily A\+T\+O\+M\+\_\+\+S\+T\+EP} command depends upon which of the {\ttfamily M\+D\+\_\+\+I\+N\+IT} or {\ttfamily O\+P\+T\+G\+\_\+\+I\+N\+IT} commands was most recently executed. If a {\ttfamily M\+D\+\_\+\+I\+N\+IT} command was more recently executed than any {\ttfamily O\+P\+T\+G\+\_\+\+I\+N\+IT} commands, {\ttfamily A\+T\+O\+M\+\_\+\+S\+T\+EP} will perform one time integration step of an MD simulation. If a {\ttfamily O\+P\+T\+G\+\_\+\+I\+N\+IT} command was more recently executed than any {\ttfamily M\+D\+\_\+\+I\+N\+IT} commands, {\ttfamily A\+T\+O\+M\+\_\+\+S\+T\+EP} will perform one iteration of a geometry optimization. After either of the above behavors, the engine updates its energy, which can be queried with the {\ttfamily $<$E\+N\+E\+R\+GY} command.\hypertarget{mdi_standard_set_cell}{}\doxysubsubsection{$>$\+C\+E\+LL}\label{mdi_standard_set_cell}
...
{\bfseries{ Data Type\+: }} M\+D\+I\+\_\+\+I\+NT ~\newline
 {\bfseries{ Quantity\+: }} 1
\end{DoxyParagraph}
\hypertarget{mdi_standard_optg_init}{}\doxysubsubsection{O\+P\+T\+G\+\_\+\+I\+N\+IT}\label{mdi_standard_optg_init}
