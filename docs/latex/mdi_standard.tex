...
All physical quantities communicated through M\+DI must be expressed in atomic units.\hypertarget{mdi_standard_standard_nodes_sec}{}\doxysection{Nodes}\label{mdi_standard_standard_nodes_sec}
