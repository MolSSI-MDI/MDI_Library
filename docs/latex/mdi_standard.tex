...
The engine proceeds to the next {\ttfamily  @\+P\+RE-\/F\+O\+R\+C\+ES } node (see \mbox{\hyperlink{mdi_standard_standard_nodes_sec}{Nodes}}). This command is not valid at the {\ttfamily @\+G\+L\+O\+B\+AL}  node.\hypertarget{mdi_standard_send_totcharge}{}\doxysubsection{$>$\+T\+O\+T\+C\+H\+A\+R\+GE}\label{mdi_standard_send_totcharge}
