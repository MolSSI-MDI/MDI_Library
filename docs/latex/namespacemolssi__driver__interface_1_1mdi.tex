...
The function returns an M\-D\-I\-\_\-\-C\-O\-M\-M that describes a connection between two codes. If no new communicators are available, the function returns {\ttfamily 0}. 