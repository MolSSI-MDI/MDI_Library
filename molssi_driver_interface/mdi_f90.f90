! Fortran 90 wrapper for the MolSSI Driver Interface
   ...
   INTEGER(KIND=C_INT), PROTECTED, BIND(C, name="MDI_COMMAND_LENGTH")        :: MDI_COMMAND_LENGTH
   INTEGER(KIND=C_INT), PROTECTED, BIND(C, name="MDI_NAME_LENGTH")           :: MDI_NAME_LENGTH
   INTEGER(KIND=C_INT), PROTECTED, BIND(C, name="MDI_NULL_COMM")             :: MDI_NULL_COMM

   INTEGER(KIND=C_INT), PROTECTED, BIND(C, name="MDI_INT")                   :: MDI_INT
   INTEGER(KIND=C_INT), PROTECTED, BIND(C, name="MDI_DOUBLE")                :: MDI_DOUBLE
   INTEGER(KIND=C_INT), PROTECTED, BIND(C, name="MDI_CHAR")                  :: MDI_CHAR
